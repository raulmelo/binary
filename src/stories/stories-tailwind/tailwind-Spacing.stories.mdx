...
export const TemplateSpacing = () => {
  const values = [{"class":"88","value":"88px"},{"class":"100","value":"100px"},{"class":"px","value":"1px"},{"class":"xs","value":"8px"},{"class":"sm","value":"16px"},{"class":"md","value":"24px"},{"class":"lg","value":"32px"},{"class":"xl","value":"40px"}]
  const spacing = {
    padding: {
      label: 'Padding',
      className: 'p',
